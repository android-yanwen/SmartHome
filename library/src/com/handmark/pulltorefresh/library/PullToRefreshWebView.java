...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	protected boolean isReadyForPullEnd() {
		double temp = (double) mRefreshableView.getContentHeight() * mRefreshableView.getScale();
		double exactContentHeight = Math.floor(temp);
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		private int getScrollRange() {
			return (int) Math.max(0, /*FloatMath.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale())*/
					Math.floor((double) mRefreshableView.getContentHeight() * mRefreshableView.getScale())
